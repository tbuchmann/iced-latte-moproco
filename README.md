...
A production-grade Spring Boot coffee marketplace backend, generated entirely with the **MoProCo** model-driven toolchain. This project is a demonstrator equivalent to the publicly known [Iced Latte](https://github.com/ZorroSign/iced-latte) reference application.
